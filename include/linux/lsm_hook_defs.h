...
LSM_HOOK(int, 0, sb_kern_mount, struct super_block *sb, int flags, void *data)
...
LSM_HOOK(int, 0, sb_parse_opts_str, char *options, struct security_mnt_opts *opts)
...
LSM_HOOK(int, 0, msg_queue_alloc_security, struct kern_ipc_perm *msq)
LSM_HOOK(void, LSM_RET_VOID, msg_queue_free_security,
	 struct kern_ipc_perm *msq)
LSM_HOOK(int, 0, msg_queue_associate, struct kern_ipc_perm *msq, int msqflg)
LSM_HOOK(int, 0, msg_queue_msgctl, struct kern_ipc_perm *msq, int cmd)
LSM_HOOK(int, 0, msg_queue_msgsnd, struct kern_ipc_perm *msq,
	 struct msg_msg *msg, int msqflg)
LSM_HOOK(int, 0, msg_queue_msgrcv, struct kern_ipc_perm *msq,
	 struct msg_msg *msg, struct task_struct *target, long type, int mode)
LSM_HOOK(int, 0, shm_alloc_security, struct kern_ipc_perm *shp)
LSM_HOOK(void, LSM_RET_VOID, shm_free_security, struct kern_ipc_perm *shp)
LSM_HOOK(int, 0, shm_associate, struct kern_ipc_perm *shp, int shmflg)
LSM_HOOK(int, 0, shm_shmctl, struct kern_ipc_perm *shp, int cmd)
LSM_HOOK(int, 0, shm_shmat, struct kern_ipc_perm *shp, char __user *shmaddr,
	 int shmflg)
LSM_HOOK(int, 0, sem_alloc_security, struct kern_ipc_perm *sma)
LSM_HOOK(void, LSM_RET_VOID, sem_free_security, struct kern_ipc_perm *sma)
LSM_HOOK(int, 0, sem_associate, struct kern_ipc_perm *sma, int semflg)
LSM_HOOK(int, 0, sem_semctl, struct kern_ipc_perm *sma, int cmd)
LSM_HOOK(int, 0, sem_semop, struct kern_ipc_perm *sma, struct sembuf *sops,
