/************************************************************************
* Copyright (C) 2012-2018, Focaltech Systems (R)\A3\ACAll Rights Reserved.
...
/* add begin by zhangchaofan@longcheer.com Touch state, 2019-01-14*/
#define TOUCH_STATE_WORKING    0
#define TOUCH_STATE_UPGRADING  1
/* add end by zhangchaofan@longcheer.com Touch state, 2019-01-14 */
