...
int fts_test_get_ini_size(char *config_name)
{
	...
	/* modify test file path by zhangchaofan start, 2018-11-30 */
    sprintf(filepath, "%s%s", FTS_INI_FILE_INI_PATH, config_name);
	/* modify test file path by zhangchaofan end, 2018-11-30 */
