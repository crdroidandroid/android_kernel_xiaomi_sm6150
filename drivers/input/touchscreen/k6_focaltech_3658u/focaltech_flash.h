...
enum FW_STATUS { FTS_RUN_IN_ERROR, FTS_RUN_IN_APP, FTS_RUN_IN_ROM, FTS_RUN_IN_PRAM, FTS_RUN_IN_BOOTLOADER,
};
enum FW_FLASH_MODE { FLASH_MODE_APP, FLASH_MODE_LIC, FLASH_MODE_PARAM, FLASH_MODE_ALL,
};
enum ECC_CHECK_MODE { ECC_CHECK_MODE_XOR, ECC_CHECK_MODE_CRC16,
};
enum UPGRADE_SPEC { UPGRADE_SPEC_V_1_0 = 0x0100, UPGRADE_SPEC_V_1_1 = 0x0101, UPGRADE_SPEC_V_1_2 = 0x0102,
};
